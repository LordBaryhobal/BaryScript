...
class Interpreter:
    ...
    def run(self):
        ...
        self.log(f"{ANSI_BRIGHT_GREEN}File read succesfully{ANSI_CLEAR}", DebugLevel.DEBUG)
        
        self.tokenizer = Tokenizer(self)
        self.tokenizer.tokenize(self.content)
        
        self.tokenizer.tree.display() ### TO REMOVE
        
        self.log(f"{ANSI_BRIGHT_GREEN}Tokenized succesfully{ANSI_CLEAR}", DebugLevel.DEBUG)
        
        self.symbolizer = Symbolizer(self)
        self.symbolizer.symbolize(self.tokenizer.tree)
        
        self.symbolizer.program.display() ### TO REMOVE
        
        self.log(f"{ANSI_BRIGHT_GREEN}Symbolized succesfully{ANSI_CLEAR}", DebugLevel.DEBUG)
        
        program = self.symbolizer.program
